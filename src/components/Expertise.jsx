  ...
  return (
    <section className="min-h-screen">
      ...
      <div className="grid lg:grid-cols-2 gap-10">
        <div className="flex items-center rounded-lg bg-[#001C30]">
          <img
            className="h-40 w-40 rounded-t-lg object-cover p-5"
        ...
        <div className="flex items-center rounded-lg bg-[#001C30]">
          ...
          <div className="flex flex-col justify-start px-5 my-5">
            <h5 className="text-xl font-bold text-neutral-800 dark:text-neutral-50">
              Git - <span className="text-teal-500">Intermediate</span>
            </h5>
            <ul className="list-disc list-inside text-white">
              <h4 className="font-medium">1 year of experience</h4>
